...
public class Recv02 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
       ...
       final   Channel channel = connection.createChannel();
        ...
        //声明队列
        channel.queueDeclare(MQProperties.PUBLISH_QUEUE_NAME_2,false,false,false,null);

        //绑定队列到交换机
        channel.queueBind(MQProperties.PUBLISH_QUEUE_NAME_2,MQProperties.EXCHANGE_NAME,"");
        ...
        channel.basicConsume(MQProperties.PUBLISH_QUEUE_NAME_2,false,consumer);
