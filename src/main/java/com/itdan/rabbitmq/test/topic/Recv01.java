...
public class Recv01 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
       ...
       final   Channel channel = connection.createChannel();
        ...
        //声明队列
        channel.queueDeclare(MQProperties.TOPIC_QUEUE_NAME_1,false,false,false,null);

        //定义roundingKey
        //绑定队列到交换机
        channel.queueBind(MQProperties.TOPIC_QUEUE_NAME_1,MQProperties.TOPIC_EXCHANGE_NAME,"product.add");
        ...
        channel.basicConsume(MQProperties.TOPIC_QUEUE_NAME_1,false,consumer);
